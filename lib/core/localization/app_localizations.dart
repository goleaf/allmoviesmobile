  ...
  static AppLocalizations of(BuildContext context) {
    ...
    fallback._localizedStrings = const <String, dynamic>{
      ...
      'home': {
        ...
        'quick_access_subtitle': 'Jump back into your favorite sections',
        'of_the_moment_movies': 'Of the moment • Movies',
        'of_the_moment_subtitle': 'Fresh picks everyone is talking about',
        'of_the_moment_tv': 'Of the moment • TV',
        'of_the_moment_subtitle_tv': 'Must-watch shows right now',
        'no_trending_movies': 'Trending movies are currently unavailable.',
        'no_trending_tv': 'Trending TV shows are currently unavailable.',
        'continue_watching': 'Continue watching',
        'continue_watching_subtitle': 'Pick up where you left off',
        'no_continue_watching': 'Add movies or shows to your watchlist to keep track of progress.',
        'new_releases': 'New releases',
        'new_releases_subtitle': 'Fresh stories released this week',
        'no_new_releases': 'No new releases available right now.',
        'personalized_recommendations': 'Recommended for you',
        'personalized_recommendations_subtitle':
            'Hand-picked titles based on popular favorites',
        'no_recommendations': 'No recommendations are available at this time.',
        'popular_people': 'Popular people',
        'popular_people_subtitle': 'The talent behind the stories',
        'no_people': 'Popular people are currently unavailable.',
        'featured_collections': 'Featured collections',
        'featured_collections_subtitle': 'Curated sagas to binge in order',
        'no_collections': 'Featured collections are currently unavailable.',
        'quick_access_movies': 'Movies',
        'quick_access_series': 'TV & Series',
        'quick_access_filters': 'Discover',
        'quick_access_genres': 'Genres',
      },
      'tv': {
        'overview': 'Overview',
        'season': 'Season',
