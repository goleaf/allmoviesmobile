...
extension CountryTranslationEntityByIndex
  ...
  List<Id> putAllByIso3166_1LocaleSync(
    List<CountryTranslationEntity> objects, {
    bool saveLinks = true,
  }) {
...
extension CountryTranslationEntityQueryWhereSort
    on
        QueryBuilder<
...
extension CountryTranslationEntityQueryWhere
    on
        QueryBuilder<
          CountryTranslationEntity,
          CountryTranslationEntity,
  ...
  QueryBuilder<
    ...
    QAfterWhereClause
  >
  iso3166_1EqualToAnyLocale(String iso3166_1) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<
    ...
    QAfterWhereClause
  >
  iso3166_1NotEqualToAnyLocale(String iso3166_1) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(
...
extension CountryTranslationEntityQueryFilter
    on
        QueryBuilder<
          CountryTranslationEntity,
          CountryTranslationEntity,
...
extension CountryTranslationEntityQueryObject
    on
        QueryBuilder<
          CountryTranslationEntity,
          CountryTranslationEntity,
...
extension CountryTranslationEntityQueryLinks
    on
        QueryBuilder<
          CountryTranslationEntity,
          CountryTranslationEntity,
...
extension CountryTranslationEntityQuerySortBy
    on
        QueryBuilder<
          CountryTranslationEntity,
          CountryTranslationEntity,
...
extension CountryTranslationEntityQuerySortThenBy
    on
        QueryBuilder<
          CountryTranslationEntity,
          CountryTranslationEntity,
...
extension CountryTranslationEntityQueryWhereDistinct
    on
        QueryBuilder<
          CountryTranslationEntity,
          CountryTranslationEntity,
...
extension CountryTranslationEntityQueryProperty
    on
        QueryBuilder<
          CountryTranslationEntity,
          CountryTranslationEntity,
