...
_$ImagesConfigurationImpl _$$ImagesConfigurationImplFromJson(
  ...
  backdropSizes:
      ...
      const [],
  logoSizes:
      (json['logo_sizes'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  posterSizes:
      ...
      const [],
  profileSizes:
      (json['profile_sizes'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  stillSizes:
      (json['still_sizes'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
);
...
_$ApiConfigurationImpl _$$ApiConfigurationImplFromJson(
  ...
  images: ImagesConfiguration.fromJson(json['images'] as Map<String, dynamic>),
  changeKeys:
      (json['change_keys'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
);
