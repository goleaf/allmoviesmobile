    ...
    return _then(
      _value.copyWith(
            ...
            withWatchMonetizationTypes:
                freezed == withWatchMonetizationTypes
...
abstract class _DiscoverFilters implements DiscoverFilters {
  const factory _DiscoverFilters({
    ...
    @JsonKey(name: 'certification_country') final String? certificationCountry,
    ...
    @JsonKey(name: 'primary_release_date.gte') final String?
        primaryReleaseDateGte,
    @JsonKey(name: 'primary_release_date.lte') final String?
        primaryReleaseDateLte,
