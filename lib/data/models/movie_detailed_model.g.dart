...
_$MovieDetailedImpl _$$MovieDetailedImplFromJson(Map<String, dynamic> json) =>
    _$MovieDetailedImpl(
      ...
      videos: (json['videos'] as List<dynamic>?)
              ...
              .toList() ??
          const [],
      imageBackdrops: (json['imageBackdrops'] as List<dynamic>?)
              ?.map((e) => ImageModel.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
      imagePosters: (json['imagePosters'] as List<dynamic>?)
              ?.map((e) => ImageModel.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
      imageProfiles: (json['imageProfiles'] as List<dynamic>?)
              ?.map((e) => ImageModel.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
...
Map<String, dynamic> _$$MovieDetailedImplToJson(_$MovieDetailedImpl instance) =>
    <String, dynamic>{
      ...
      'watchProviders':
          MovieDetailed._watchProvidersToJson(instance.watchProviders),
